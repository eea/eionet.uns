...
INSERT INTO `CHANNEL` (`ID`,`STYLESHEET_ID`,`NOTIFICATION_TEMPLATE_ID`,`CREATOR`,`TITLE`,`DESCRIPTION`,`LAST_HARVEST`,`MODE`,`FEED_URL`,`REFRESH_DELAY`,`CREATION_DATE`,`CSTATUS`,`SECONDARY_ID`,`LANGUAGE_ID`) VALUES 
 (1,2,1,1,'Obligations statistics','Obligations per year diagram for interval 2001-2009','1990-02-01 00:00:00','PULL','http://rod.eionet.europa.eu/events.rss',120,UTC_TIMESTAMP(),1,'3b0f5f8db66da74d3acbca0e0acdd6d84539b010','en');
