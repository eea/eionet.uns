...
<head>
    ...
    %>
    <link rel="stylesheet" type="text/css" href="https://www.eionet.europa.eu/styles/eionet2007/print.css"
          media="print"/>
    <link rel="stylesheet" type="text/css" href="https://www.eionet.europa.eu/styles/eionet2007/handheld.css"
          media="handheld"/>
    <link rel="stylesheet" type="text/css" href="https://www.eionet.europa.eu/styles/eionet2007/screen.css"
          media="screen" title="Eionet 2007 style"/>
    <link rel="stylesheet" type="text/css" href="<c:url value="/css/portlet.css"/>" media="screen"
    ...
    <% if (session.getAttribute(EionetCASFilter.CAS_FILTER_USER) == null || session.getAttribute(EULoginCASFilter.CAS_FILTER_USER) == null) {%>
    <script type="text/javascript">
        //<![CDATA[
    ...
    <link rel="alternate" type="application/rss+xml" title="Unified Notification Service RSS"
          href="http://uns.eionet.europa.eu/events"/>
            ...
            <div id="righttools">
                ...
                <h:panelGroup rendered="#{(empty sessionScope.user) or not sessionScope.user.loggedIn }">
                    <f:verbatim>
                        ...
                        <a id="euloginlink" href="<%=EULoginCASFilter.getCASLoginURL(request)%>" title="EU Login">EU Login</a>
                        <%--							<a id="loginlink" href="<c:url value="/pages/login.jsp" />" title="Login">Login</a>--%>
                    </f:verbatim>
                </h:panelGroup>
                <a href="#" id="pagehelplink"
                   onclick="javascript:openWindow('<c:url value="/help/help.jsp"/>','onlinehelp');"
                   title="Help"><span><fmt:message key="label.menu.help"/></span></a>
                ...
                <a id="fullscreenlink" href="javascript:toggleFullScreenMode()" title="Switch to/from full screen mode"><span>Switch to/from full screen mode</span></a>
                    ...
                    <%--						</div>--%>
                    <%--					</form>--%>
                <a id="eionetlink" title="Go to Eionet portal"
                   href="https://www.eionet.europa.eu/"><span>Eionet portal</span></a>
            </div>
        </div>
        <div id="pagehead">
            <f:subview id="header">
