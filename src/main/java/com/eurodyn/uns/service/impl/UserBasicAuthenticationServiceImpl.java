package com.eurodyn.uns.service.impl;
...
@Service
public class UserBasicAuthenticationServiceImpl implements UserBasicAuthenticationService {

    public UserBasicAuthenticationServiceImpl() {
    }
