			...
			function imageManage() {
				...
				childWin = window.open(applicationRoot+'/do/admin/editUI/imageManagerSetup', null, "help=no,status=no,scrollbars=yes,resizable=yes" + move + ",width=" + w + ",height=" + h + ",dependent=yes", true);
