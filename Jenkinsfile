pipeline {
  ...
  environment {
    GIT_NAME = "eionet.uns"
    SONARQUBE_TAGS = "uns.eionet.europa.eu"
    registry = "eeacms/uns"
    dockerImage = ''
    tagName = ''
    unsTemplate = "templates/uns"
